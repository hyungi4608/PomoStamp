...
public class StudyRecordServiceImpl implements StudyRecordService {
    ...
    public StudyRecordResponse.dayRecord getDayRecord(String userId, LocalDate when) {
        ...
        List<StudyRecord> list = studyRecordRepository.findAllByUser_UserIdAndStartRecordBetween(userId, st, ed);
    ...
    public StudyRecordResponse.grassRecord getGrassRecords(LocalDate st, LocalDate ed, User user){
        ...
        List<StatisticRecord> list = statisticRecordRepository.findAllByStatisticRecordId_User_UserIdAndStatisticRecordId_StudyDateBetween(user.getUserId(), st, ed);
